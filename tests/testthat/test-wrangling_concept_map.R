testthat::test_that("wrangling_concept_map transforms wide to long correctly", {
  ...
  #  of the NA filter in your function)
...
testthat::test_that("Function handles missing required columns", {
...
testthat::test_that("Function handles missing mapping columns", {
  bad_data <- data.table(
    concept_id = "C1",
    cdm_name = "CDM1",
    cdm_table_name = "T1",
...
testthat::test_that("Function correctly filters out NA cdm_columns", {
  mock_map <- data.table(
    concept_id = "C1",
    cdm_name = "CDM1",
    cdm_table_name = "T1",
